...
import com.company.primenumbers.rest.algorithm.BruteForce;

class SieveOfEratosthenesTest {

	@Test
	void testWithNumber10() {
		List<BigInteger> primes = new BruteForce().generatePrimeNumbers(BigInteger.valueOf(10));
	...
	void testWithNumber1() {
		List<BigInteger> primes = new BruteForce().generatePrimeNumbers(BigInteger.valueOf(1));
		assertEquals(0, primes.size());
	}
	
	@Test
	void testWithNumber11() {
		List<BigInteger> primes = new BruteForce().generatePrimeNumbers(BigInteger.valueOf(11));
